...
# puts multiple_run([3, 26, 1001, 26, -4, 26, 3, 27, 1002, 27, 2, 27, 1, 27, 26, 27, 4, 27, 1001, 28, -1, 28, 1005, 28, 6, 99, 0, 0, 5], [9, 8, 7, 6, 5])
puts multiple_run([3, 26, 1001, 26, -4, 26, 3, 27, 1002, 27, 2, 27, 1, 27, 26,
...
# r = multiple_run(arr, p)
# puts "#{p} #{r}"
# r
# end
# puts result.max
# result = [5, 6, 7, 8, 9].map(&.to_i64).permutations.map do |p|
# multiple_run(arr, result.max, p)
# end
# puts result.max
